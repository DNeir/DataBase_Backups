...
-- Started on 2025-08-30 14:36:59 -05
...
--
-- TOC entry 3599 (class 1262 OID 17178)
-- Name: odontology_post; Type: DATABASE; Schema: -; Owner: neir
--

CREATE DATABASE odontology_post WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'es_CO.UTF-8';


ALTER DATABASE odontology_post OWNER TO neir;

\connect odontology_post
...
-- Completed on 2025-08-30 14:36:59 -05
